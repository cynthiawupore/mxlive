 ...
 // HEADER
     ...
     // CONTAINER
         // NAV
            ...
            // ALL
            $('.layer06-all-list ul li').click(function(){

                // $(this).parents(2).find('.layer06-all-list-detail').hide()
                $(this).find('.layer06-all-list-detail').slideToggle(200)();
              

                // $(this).parents(2).find('i').removeClass('layer06-all-list-i')
                // $(this).find('i').addClass('layer06-all-list-i')
         ...
         // CONTAINER
             // NAV
                ...
                $('.layer06-all-list ul li').click(function(){
                    ...
                    $(this).parents(2).find('.layer06-all-list-detail').hide()
                    $(this).find('.layer06-all-list-detail').show()

                    $(this).parents(2).find('i').removeClass('layer06-all-list-i')
                    $(this).find('i').addClass('layer06-all-list-i')


                    $(this).parents(1).find('label').css({
                      color : "#d0d0d0"
                    })
                    $(this).find('label').css({
                      color : "#bc0000"
